...
always @(posedge clk) begin
    if (rst) begin
        ...
        // HOLD output registers during stall
        l1_s5    <= l1_s5;
        l2_s5    <= l2_s5;
        dl1x_s5  <= dl1x_s5;
        dl2x_s5  <= dl2x_s5;
        ...
        ovalid <= ovalid;   // hold valid
    end
    else if (valid) begin
        // CALCULATE NEW VALUES
        l1z1_s5   <= l1_s4 * z1_s4; 
        l2z2_s5   <= l2_s4 * z3_s4;               // l3 * z3 
        l3z3_s5   <= ((32'sd1 <<< 8) - l1_s4 - l2_s4) * z2_s4;

        dlx1z1_s5 <= dl1x_s4 * z1_s4;
        dlx2z2_s5 <= dl2x_s4 * z3_s4;
        dlx3z3_s5 <= (- dl1x_s4 - dl2x_s4) * z2_s4;

        dly1z1_s5 <= dl1y_s4 * z1_s4;
        dly2z2_s5 <= dl2y_s4 * z3_s4;
        dly3z3_s5 <= (- dl1y_s4 - dl2y_s4) * z2_s4;
