...
#
# Generated by export_simulation on Sat Nov 08 00:41:05 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './axis_combiner_1.sh' script.

./axis_combiner_1.sh -reset_run
...
./axis_combiner_1.sh -noclean_files

For more information on the script, please type './axis_combiner_1.sh -help'.
