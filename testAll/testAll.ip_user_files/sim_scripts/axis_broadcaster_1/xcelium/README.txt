...
#
# Generated by export_simulation on Sat Nov 08 00:40:07 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './axis_broadcaster_1.sh' script.

./axis_broadcaster_1.sh -reset_run
...
./axis_broadcaster_1.sh -noclean_files

For more information on the script, please type './axis_broadcaster_1.sh -help'.
