...
#
# Generated by export_simulation on Fri Nov 07 22:51:57 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './axis_broadcaster_0.sh' script.

./axis_broadcaster_0.sh -reset_run
...
./axis_broadcaster_0.sh -noclean_files

For more information on the script, please type './axis_broadcaster_0.sh -help'.
