...
#
# Generated by export_simulation on Sat Nov 08 02:29:30 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './axis_switch_1.sh' script.

./axis_switch_1.sh -reset_run
...
./axis_switch_1.sh -noclean_files

For more information on the script, please type './axis_switch_1.sh -help'.
