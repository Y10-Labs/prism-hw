...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=3,da_clkrst_cnt=2,da_ps7_cnt=2,synth_mode=Global}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [127:0]repeater_0_m_TDATA;
  wire repeater_0_m_TLAST;
  wire repeater_0_m_TREADY;
  wire repeater_0_m_TVALID;
  ...
  design_1_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_50M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(repeater_0_m_TDATA),
        .s_axis_s2mm_tkeep({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s_axis_s2mm_tlast(repeater_0_m_TLAST),
        .s_axis_s2mm_tready(repeater_0_m_TREADY),
        .s_axis_s2mm_tvalid(repeater_0_m_TVALID));
  ...
  design_1_repeater_0_0 repeater_0
       (.aclk(Net),
        .aresetn(rst_ps7_0_50M_peripheral_aresetn),
        .m_tdata(repeater_0_m_TDATA),
        .m_tlast(repeater_0_m_TLAST),
        .m_tready(repeater_0_m_TREADY),
        .m_tvalid(repeater_0_m_TVALID),
        .s_tdata(axi_dma_0_M_AXIS_MM2S_TDATA),
        .s_tlast(axi_dma_0_M_AXIS_MM2S_TLAST),
        .s_tready(axi_dma_0_M_AXIS_MM2S_TREADY),
        .s_tvalid(axi_dma_0_M_AXIS_MM2S_TVALID));
  ...
  design_1_smartconnect_0_1 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(Net),
        .aresetn(rst_ps7_0_50M_peripheral_aresetn));
  design_1_smartconnect_0_2 smartconnect_1
